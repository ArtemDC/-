...
def study1():
    if list_widget.currentItem().text():
        for q in q_list:
            if q.question == list_widget.currentItem().text():
                right_lb.setText(q.right)
...
list_widget.itemClicked.connect(study1)
